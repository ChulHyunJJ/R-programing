exam <- read.csv("C:/Users/Chris/MyGit/R_Practice/Basic R/Data/exam.csv")
head(exam)
str(exam)
...
write.csv(exam, "C:/Users/Chris/MyGit/R_Practice/Basic R/Data/exam_df.csv")
write.csv(exam,"C:/Users/Chris/MyGit/R_Practice/Basic R/Data/exam_df.csv", quote=F, row.names=F, fileEncoding='utf-8')
